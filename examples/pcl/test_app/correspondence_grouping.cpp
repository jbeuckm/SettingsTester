...
parseCommandLine (int argc, char *argv[])
{
  ...
  pcl::console::parse_argument (argc, argv, "--show_vis", show_vis_);
}
...
main (int argc, char *argv[])
{
  ...
  std::cout << "\"model_keypoints\":" << model_keypoints->size() << ",";
  std::cout << "\"scene_points\":" << scene->size() << ",";
  std::cout << "\"scene_keypoints\":" << scene_keypoints->size() << ",";
  std::cout << "\"correspondences\":" << model_scene_corrs->size();
  std::cout << "}" << std::endl;
